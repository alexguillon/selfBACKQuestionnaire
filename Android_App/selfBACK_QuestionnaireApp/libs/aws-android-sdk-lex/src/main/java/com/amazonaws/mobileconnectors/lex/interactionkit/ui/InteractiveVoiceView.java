...
public class InteractiveVoiceView extends View {
    ...
    private static final int DEFAULT_COLOR_BUTTON_BOUNDARY = Color.parseColor("#000000");
    private static final int DEFAULT_COLOR_TINT_NORMAL = Color.parseColor("#197ea9");
    private static final int DEFAULT_COLOR_TINT_LISTENING = Color.parseColor("#FF002654");
    private static final int DEFAULT_COLOR_TINT_TALKING = Color.parseColor("#FF002654");
    private static final int DEFAULT_COLOR_TINT_WAITING = Color.parseColor("#FF002654");
    private static final int DEFAULT_COLOR_ANIMATED_CIRCLE = Color.parseColor("#FF002654");
    private static final int DEFAULT_COLOR_ANIMATED_RING = Color.parseColor("#FF002654");
    ...
    //Sentence for selfBACK project
    private String stateOne = "I am not listening to you, click on the microphone icon to talk";
    private String stateTwo = "I am listening to you...";
    private String stateThree = "I am communicating with the server, hold a moment please.";
    private String stateFour = "";
    private String stateFive = "";
    private String stateSix = "";

    private boolean neverTalked=true;
    ...
    private void init(TextView tv) {
        ...
        bitmapDrawableLexIcon = new BitmapDrawable(
                getResources(),
                BitmapFactory.decodeResource(getResources(), R.drawable.lex_icon)
        );
        ...
        mButtonRadiusPix = dip2pix(BIB_INT_DP);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (state) {
            case TRANSITION_TO_LISTENING:
                this.tv.setText(stateFour);
                break;
            case LISTENING:
                this.tv.setText(stateTwo);
                neverTalked=false;
    ...
    public void setStateTextView(TextView tv){
        this.tv=tv;
    }
